...
country_data = Any[
    ...
    Any[
        Dict(
            ...
            "id" => "AND",
            "iso2Code" => "AD",
            "incomeLevel" => Dict("id" => "NOC", "value" => "High income: nonOECD"),
            "adminregion" => Dict("id" => "", "value" => ""),
            "lendingType" => Dict("id" => "LNX", "value" => "Not classified"),
            "region" => Dict(
                "id" => "ECS",
        ...
        Dict(
            ...
            "id" => "ARB",
            "iso2Code" => "1A",
            "incomeLevel" => Dict("id" => "NA", "value" => "Aggregates"),
            "adminregion" => Dict("id" => "", "value" => ""),
            "lendingType" => Dict("id" => "", "value" => "Aggregates"),
            "region" => Dict("id" => "NA", "value" => "Aggregates"),
            "capitalCity" => "",
            "name" => "Arab World",
            "longitude" => "",
        ),
        ...
        Dict(
            ...
            "id" => "ARG",
            "iso2Code" => "AR",
            "incomeLevel" => Dict("id" => "UMC", "value" => "Upper middle income"),
            "adminregion" => Dict(
                "id" => "LAC",
                "value" => "Latin America & Caribbean (developing only)",
            ),
            "lendingType" => Dict("id" => "IBD", "value" => "IBRD"),
            "region" => Dict(
                "id" => "LCN",
